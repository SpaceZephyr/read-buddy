...
description: First-time setup flow for read-x-markdown preferences
---
...
options:
  - label: "User (Recommended)"
    description: "~/.read-buddy/ (all projects)"
  - label: "Project"
    description: ".read-buddy/ (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.read-buddy/read-x-markdown/EXTEND.md` | All projects |
| Project | `.read-buddy/read-x-markdown/EXTEND.md` | Current project |
